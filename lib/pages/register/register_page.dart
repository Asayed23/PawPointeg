          ...
          children: [
            ...
            new Flexible(
                child: TextFormField(
                    onSaved: (val) => _username = val,
                    validator: (val) =>
                        val.length < 1 ? 'Username too short' : null,
                    decoration: InputDecoration(
            ...
            Icon(Icons.mail, color: Colors.black, size: w(4)),
          ],
        ));
  }
          ...
          children: [
            ...
            new Flexible(
              ...
              child: TextFormField(
                  ...
                  validator: (val) =>
                      val.length < 1 ? 'fullname too short' : null,
                  decoration: InputDecoration(
                    enabledBorder: UnderlineInputBorder(),
                    // disabledBorder: UnderlineInputBorder(),
                    // border: UnderlineInputBorder(),
            ...
            Icon(Icons.perm_identity, color: Colors.black, size: w(4)),
          ],
        ));
  }
          ...
          children: [
            ...
            new Flexible(
              ...
              child: TextFormField(
                  ...
                  validator: (val) =>
                      val.length < 11 ? 'Phone too short' : null,
                  decoration: InputDecoration(
                    enabledBorder: UnderlineInputBorder(),
                    // disabledBorder: UnderlineInputBorder(),
                    // border: UnderlineInputBorder(),
            ...
            Icon(Icons.phone, color: Colors.black, size: w(4)),
          ],
        ));
  }
    ...
    return Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            Icon(Icons.vpn_key, color: Colors.black, size: w(4)),
          ],
        ));
  }
...
// password:12345678
  ...
  void _registerUser() async {
    ...
    if (response.statusCode == 200) {
      ...
      _showErrorSnack('Please fill all inputs');
    }
  }
                  ...
                  child: Column(children: [
                    Form(
                        ...
                        child: Column(children: [
                          ...
                          _showPasswordInput(),
                          Padding(
                            padding: EdgeInsets.only(top: h(3), right: w(5)),
                            child: Align(
                    ...
                    Padding(
                        padding: EdgeInsets.only(top: h(1), left: w(5)),
                        child: Align(
